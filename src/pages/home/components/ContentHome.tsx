  ...
  return (
    <div className="ml-6 mt-16 w-full pr-4">
      ...
      <div className="flex w-full mt-10">
        <div className="w-1/4 h-40 bg-zinc-100 rounded-lg p-4 mt-4 pr-9 shadow-md mr-4">
          <div className="flex mr-3 w-9 h-9 border-2 border-blue-400 rounded-full bg-blue-600 text-white">
        ...
        <div className="w-1/4 h-40 bg-zinc-100 rounded-lg p-4 mt-4 pr-9 shadow-md">
        <div className="flex mr-3 w-9 h-9 border-2 border-blue-400 rounded-full bg-blue-600 text-white">
