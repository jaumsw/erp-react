...
export const Login = () => {
    ...
    return(
        <div className="min-h-screen flex items-center justify-center bg-zinc-600">
            <form className="max-w-lg w-full bg-zinc-100 shadow-xl rounded-lg p-20 mb-7">
                ...
                <div className="roudened-md shadow-sm -space-y-1  relative">
                    <input 
                        ...
                        placeholder="" 
                     />
                    <label htmlFor="email-address" className="select-none absolute text-sm text-gray-500 dark:text-gray-500 duration-300 transform -translate-y-7 scale-75 top-3.5 origin-[0] start-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-110 peer-placeholder-shown:translate-y-0 peer-focus:scale-90 peer-focus:-translate-y-8 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                        Email
                    </label>
              </div>
            ...
            <label htmlFor="remember" className="text-sm font-semibold text-grey-500">Lembrar de mim?</label>
            </div>
