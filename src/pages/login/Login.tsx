...
export const Login = () => {
    ...
    const showLoader = () => {
        ...
        if (loaderContainer) {
            ...
            loaderDiv.innerHTML = `
                <div role="status">
                    <svg aria-hidden="true" class="mt-4 inline w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
